...
const styles = stylex.create({
	alert: {
		...
		backgroundColor: "var(--card, #171717)",
	...
	[AlertVariants.DEFAULT]: {
		color: "var(--primary, #2eb6d1)",
	},

	[AlertVariants.WARNING]: {
		color: "var(--warning, #F1CB00)",
	},

	[AlertVariants.DANGER]: {
		color: "var(--destructive, #FF2E00)",
	},

	[AlertVariants.SUCCESS]: {
		color: "var(--success, #30AB53)",
	},
